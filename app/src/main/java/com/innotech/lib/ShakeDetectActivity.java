...
public class ShakeDetectActivity implements SensorEventListener {
	...
	private static final int SHAKE_CHECK_THRESHOLD = 300;

	/**
	 * After we detect a shake, we ignore any events for a bit of time. We don't want two shakes to close together.
	 */
	private static final int IGNORE_EVENTS_AFTER_SHAKE = 5000;
	...
	private static final long MINIMUM_EACH_DIRECTION = 10;
    ...
    protected void triggerShakeDetected() {
		for(com.innotech.lib.ShakeDetectActivityListener listener: listeners) {
